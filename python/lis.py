...
def calc_pdockq(avg_if_plddt, n_if_contacts):
    ...
    n_if_contacts = count of such contacts. Same formula here, fed LIpLDDT/LIA (PAE-cutoff-filtered
    interface: pDockQ_LIA) or cLIpLDDT/cLIA (PAE-cutoff AND physical-contact filtered: pDockQ_cLIA)
...
def calc_pdockq2_chain(pae_block, contact_block, plddt_i):
    ...
    how every other metric in this file (LIS, ipSAE, actifpTM, pDockQ_LIA/cLIA) is already reported
