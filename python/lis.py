...
def calc_pdockq(avg_if_plddt, n_if_contacts):
    ...
    interface (pDockQ) or cLIpLDDT/cLIA (PAE-cutoff AND physical-contact filtered: cpDockQ) instead
    -- i.e. the same relationship cLIS already has to LIS, applied to pDockQ's formula.
